...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getRebels = function () {
        ...
        this.http.get(this.basePath('Rebel', 'AC')).subscribe(function (val) {
            ...
            for (var row in data) {
                var ship = data[row];
                var rebel = new _app_core_model_ship__WEBPACK_IMPORTED_MODULE_3__["Ship"](ship[0], ship[1], ship[2], ship[3], ship[4], ship[5], ship[6], ship[27], ship[28]);
    ...
    DataService.prototype.getImperials = function () {
        ...
        this.http.get(this.basePath('Imperial', 'AA')).subscribe(function (val) {
            ...
            for (var row in data) {
                var ship = data[row];
                var imperial = new _app_core_model_ship__WEBPACK_IMPORTED_MODULE_3__["Ship"](ship[0], ship[1], ship[2], ship[3], ship[4], ship[5], ship[6], ship[24], ship[25]);
    ...
    DataService.prototype.getScum = function () {
        ...
        this.http.get(this.basePath('Scum', 'AE')).subscribe(function (val) {
            ...
            for (var row in data) {
                var ship = data[row];
                var scum = new _app_core_model_ship__WEBPACK_IMPORTED_MODULE_3__["Ship"](ship[0], ship[1], ship[2], ship[3], ship[4], ship[5], ship[6], ship[29], ship[30]);
