...
var Ship = /** @class */ (function () {
    function Ship(name, cost, pilot, unique, faction, shipAbility, pilotAbility, size, agility, initiative, attack, hull, shields) {
        this.name = name;
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getRebels = function () {
        var ships = [];
        this.http.get(this.basePath('Rebel', 'AG')).subscribe(function (val) {
            var data = val.values;
            for (var row in data) {
                var ship = data[row];
                var rebel = new _app_core_model_ship__WEBPACK_IMPORTED_MODULE_3__["Ship"](ship[0], ship[1], ship[2], ship[3], ship[4], ship[5], ship[6], ship[27], ship[30], ship[28], ship[29], ship[31], ship[32]);
