...
var SquadComponent = /** @class */ (function () {
    ...
    SquadComponent.prototype.squadPoints = function (faction, factionUpgrades, squad) {
        ...
        squad.forEach(function (s) {
            s.totalCost = s.cost;
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.talent);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.sensor);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.cannon1);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.cannon2);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.torpedo1);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.modification1);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.modification2);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.modification3);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.crew1);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.crew2);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.crew3);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.gunner1);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.astromech);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.force);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.turret);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.title);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.device1);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.device2);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.missile1);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.missile2);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.configuration);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.illicit1);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.illicit2);
            s.totalCost += _this.pointsForUpgrade(s, factionUpgrades, s.tech);
            points += s.totalCost;
        });
        this.showLink = false;
        return points;
