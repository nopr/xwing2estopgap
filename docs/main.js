...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getImperials = function () {
        var ships = [];
        this.http.get(this.basePath('Imperial', 'AF')).subscribe(function (val) {
            var data = val.values;
            for (var row in data) {
                var ship = data[row];
                var imperial = new _app_core_model_ship__WEBPACK_IMPORTED_MODULE_3__["Ship"](ship[0], ship[1], ship[2], ship[3], ship[4], ship[5], ship[6], ship[24], ship[25], ship[27], ship[28], ship[31], ship[32], '');
    ...
    DataService.prototype.getScum = function () {
        var ships = [];
        this.http.get(this.basePath('Scum', 'AI')).subscribe(function (val) {
            var data = val.values;
            for (var row in data) {
                var ship = data[row];
                var scum = new _app_core_model_ship__WEBPACK_IMPORTED_MODULE_3__["Ship"](ship[0], ship[1], ship[2], ship[3], ship[4], ship[5], ship[6], ship[29], ship[32], ship[30], ship[31], ship[33], ship[34], '');
